...
const AnimeCard = ({
  ...
  // دالة لتفعيل الإعلان عند الضغط على البطاقة
  const handleAdClick = (e: React.MouseEvent) => {
    window.open(
      "https://www.profitableratecpm.com/t2eg6dmn?key=7c33826c3ffd0ea547a88fd6d39c3d7a",
      "_blank"
    );
    // يمكن السماح للانتقال للرابط الأصلي بعد فتح الإعلان أو منعه حسب الرغبة
    // إذا أردت منع الانتقال للأنمي أضف: e.preventDefault();
  };

  return (
    <>
      {/* رابط إعلان مخفي لأغراض تتبع أو إعلانات */}
      <a
        href="https://www.profitableratecpm.com/t2eg6dmn?key=7c33826c3ffd0ea547a88fd6d39c3d7a"
        style={{ display: "none" }}
        tabIndex={-1}
        aria-hidden="true"
      >
      ...
      {/* البطاقة الأصلية */}
      <Link href={props.href as string} onClick={handleAdClick}>
        <div
          className={cn([
